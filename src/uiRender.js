...
<div class="px-2 py-1 space-y-1 bg-gray-800/70" data-toggle="card-header">
    ...
    <div class="grid grid-cols-[auto_1fr_auto] items-center w-full gap-2">
        ...
        <div class="flex-shrink-0 flex items-center justify-end">
            ...
            bg-green-700 hover:bg-green-500 selected:bg-green-900 text-white font-semibold transition text-center leading-tight whitespace-pre-line">報告<br>する</button>
        </div>
    </div>
